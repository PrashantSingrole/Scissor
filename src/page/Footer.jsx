              ...
              <div class="row">
                <div class="col-lg-4 col-md-6 mb-4 mb-md-0">
                  <h5 class="text-uppercase text-color">
                    Onilne Salon Service System
                  </h5>

                  <p>
                    Being a 24/7 Salon is one of our best amenities because we
                    can offer our customer unrestricted freedom of access from
                    sun up to sun down and everywhere in between. You no longer
                    have to worry about anything in Salon at any time!
                  </p>
                </div>
